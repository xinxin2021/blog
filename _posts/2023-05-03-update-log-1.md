...
warn: 没有警告
error: 没有错误
warn-block: [[点一下,[好吧，其实没有警告,测试一下换行]]]
error-block: [[再点一下,[其实也没有错误,再测试一下换行]]]
---
...
本文章采用[CC-BY-NC-SA 4.0国际](https://creativecommons.org/licenses/by-nc/4.0/deed.zh)许可协议进行许可(不包括引用的知识共享许可证徽章)。
